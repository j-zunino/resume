...
#let resume(
  ...
  author-name: "Juan Bautista Zunino",
  ...
  website: "",
  linkedin-user-id: "juanbautistazunino",
  github-username: "j-zunino",
  body,
) = {
  set document(
...
#let period_worked(start-date, end-date) = {
  ...
  if type(end-date) == str and end-date == "Presente" {
    end-date = datetime.today()
  }

  return [
    #let my-date = start-date
    #custom-date-format(start-date, "Month YYYY", "es") --
    #if (
      ...
      #custom-date-format(end-date, "MMMM YYYY", "es")
    ]
  ]
}
